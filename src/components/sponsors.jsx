export const Sponsors = () => (
    <div className="w-full h-min z-30">
        <div className="w-5/6 mx-auto h-full flex flex-row flex-wrap justify-between align-middle bg-green-500">
            <div className="w-64 flex-grow mx-auto h-64 grid place-items-center relative bg-green-500">
